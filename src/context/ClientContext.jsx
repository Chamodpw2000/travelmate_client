...
const ClientContextProvider = (props) => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://travelmate-backend-zuqb.onrender.com/travelmate/allHospitals"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://travelmate-backend-zuqb.onrender.com/transportation/getAllTransportServices"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://travelmate-backend-zuqb.onrender.com/travelmate/allAccomodations"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://travelmate-backend-zuqb.onrender.com/travelmate/gettravelmatefeedback"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://travelmate-backend-zuqb.onrender.com/travelmate/allRestaurants"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://travelmate-backend-zuqb.onrender.com/travelmate/allPrePlannedTrips"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://travelmate-backend-zuqb.onrender.com/travelmate/getAllRestaurantReviews"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://travelmate-backend-zuqb.onrender.com/travelmate/getAllHotelReviews"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://travelmate-backend-zuqb.onrender.com/travelmate/getAllGuideReviews"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://travelmate-backend-zuqb.onrender.com/travelmate/allDestinations"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://travelmate-backend-zuqb.onrender.com/travelmate/approvedVillas"
      )
      .then((response) => {
        setAllVillas(response.data);
      })
      .catch((error) => {
        console.log("Villas fetch error:", error);
      });
  }, []);
